...
// To go live: in Mailchimp go to Audience -> Signup forms -> Embedded forms,
// copy the generated HTML, and paste it between the backticks below (replacing
// the placeholder). No other edits needed — keep the backticks and the
// String.raw`...` wrapper so the raw HTML is passed through untouched.
// ============================================================================
const mailchimpEmbed = String.raw`
...
const ContactPage = ({ location, data }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p>
        Questions? Email Amy Luning at
        info@sonorawriters.com.
      </p>
      <p>
      ...
      {/* Mailchimp signup form — replaces the previous Google Form. Edit the
          mailchimpEmbed constant at the top of this file to swap in the code. */}
      <div dangerouslySetInnerHTML={{ __html: mailchimpEmbed }} />
    </Layout>
  );
};
