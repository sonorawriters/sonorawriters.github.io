...
const MeetingsPage = ({ location, data }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      <h1>Meetings</h1>
      <p>
        We generally (but not always! see the <a href="#meeting-dates">dates</a>{" "}
        below) meet on Second Saturdays from 10:30am to 12:30pm for a friendly peer critique.
        <br />
        <br />
